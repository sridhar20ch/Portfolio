      ...
      <div className="flex flex-col md:flex-row gap-8 items-center md:items-start justify-between">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center md:items-start flex-1 text-center md:text-left">
           ...
           <div className="space-y-4">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-slate-900 tracking-tight font-serif mb-2">
                {info.name}
              </h1>
              <div className="text-academic-blue text-lg font-medium tracking-wide">
                Chemistry Researcher
              </div>
            </div>
            
            <div className="flex flex-col gap-1.5 text-slate-600 text-sm items-center md:items-start">
